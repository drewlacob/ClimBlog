  ...
  return (
    ...
    >
      ...
      <Grid container sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-evenly' }}>
        ...
        >
          <TextField margin="normal" required id="title" label="Title" name="title" />
          <TextField margin="normal" id="date" label="Date" name="date" />
          <TextField margin="normal" id="grade" label="Grade" name="grade" />
          <Grid container direction="row" sx={{ my: 1 }}>
            <Typography>Rate your experience: </Typography>
            <Rating name="rating" value={rating || 0} sx={{ ml: 2 }} onChange={(e) => setRating(e.target.value)} />
          </Grid>
          <TextField
            margin="normal"
            id="description"
